                ...
                <div class="card-body">
                  ...
                  <form class="row g-3" novalidate action="" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <div class="eye-cover">
                        <input type="password" class="form-control" name="pass1" id="password1" aria-describedby="passwordHelp" required  onkeyup="myFunction()">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" name="btnSubmit" type="submit">Reset</button>
                    </div>
                    <div class="col-12">
...
if (isset($_POST['btnSubmit'])) {
  ...
  if (!empty($pass1) && !empty($pass2)) {
    ...
    if($pass1 == $pass2){
      ...
      $sql = "UPDATE `admin_master` SET `password` = '$pass1' WHERE `id`= 1 ";
