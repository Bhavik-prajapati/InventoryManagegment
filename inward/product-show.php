            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body overflow-x-scroll">
                        <h5 class="card-title">
                        <a href="product-add.php" class="btn btn-dark">Add New</a>
                        </h5>
                            ...
                            <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <a href="product-add.php?id=<?php echo $row["id"] ?>" class="bi bi-pencil-square btn btn-light m-1 my-btn-edit" style="padding:10px 20px; color:white; background-color:#e88125;"></a>
